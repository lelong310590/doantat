...
@section('pageTitle', trans('wallet::wallet.sidebar.wallet.edit'))

@section('content')

    <form action="{{route('alucms::wallet.edit.post', $wallet->id)}}" method="post">
        {{csrf_field()}}
        <div class="row">
            <div class="col-8 col-xs-12">
                <div class="card">
                    <div class="card-header bg-info py-3 text-white">
                        ...
                        <h5 class="card-title mb-0 text-white">{{trans('wallet::wallet.sidebar.wallet.edit')}}</h5>
                    </div>
